...
describe('SectionDetailPanel', () => {
  it('shows empty state when no section is selected', () => {
    renderWithQuery(<SectionDetailPanel section={null} recommendations={[]} />);
  ...
  it('shows section title when section is provided', () => {
    ...
    renderWithQuery(<SectionDetailPanel section={section} recommendations={[]} />);
  ...
  it('shows linked recommendations', () => {
    ...
    renderWithQuery(<SectionDetailPanel section={section} recommendations={[rec]} />);
