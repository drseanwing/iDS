...
interface MagicAppImportDialogProps {
  guidelineId: string;
  isOpen: boolean;
  onClose: () => void;
...
export function MagicAppImportDialog({
  guidelineId,
  isOpen,
  onClose,
  onSuccess,
}: MagicAppImportDialogProps) {
  ...
  async function handleImport() {
    ...
    try {
      ...
      const response = await apiClient.post<ImportResult>(
        `/guidelines/${guidelineId}/magicapp/import`,
        formData,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-semibold text-gray-900">Import MagicApp</h2>
          <button
            onClick={onClose}
        ...
        {step === 'select' && (
          <div className="flex flex-col items-center gap-4 py-8">
            ...
            <p className="text-sm text-gray-600 text-center max-w-sm">
              Upload a MagicApp JSON export file
            </p>
            <input
              ref={fileInputRef}
              type="file"
        ...
        {step === 'importing' && (
          <div className="flex flex-col items-center gap-4 py-8 text-center">
            ...
            <p className="text-sm text-gray-600">Importing MagicApp data…</p>
          </div>
        )}
          ...
          <div className="flex flex-col items-center gap-4 py-8 text-center">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-1 text-sm text-gray-600">
                <li>
                  <strong>{result.created.sections}</strong> section(s) created
                </li>
                <li>
                  <strong>{result.created.recommendations}</strong> recommendation(s) created
                </li>
                <li>
                  <strong>{result.created.references}</strong> reference(s) created
                </li>
                <li>
